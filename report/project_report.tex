...
\begin{itemize}
	...
	\item Peak Signal to Noise Ratio (PSNR) : Ratio between the maximum possible value and the value of distorsion in the image. Resolve the MSE problem, thT IS THE DEPENDENCE with the pixel scale. The higher the PSNR, the better the quality of the reconstructed image.
